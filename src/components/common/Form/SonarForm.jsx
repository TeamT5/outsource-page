  ...
  useEffect(() => {
    setErrorMessages(() => {
      return {
        ...
        'company-size': validateRequire('Company Size', formData['company-size']),
  ...
  return (
    ...
    >
      ...
      <PostFormInput
        ...
        errorMessage={errorMessages['company-size']}
        placeholder="Type Your Company Size"
        onChange={(e) => {
          const value = e.target.value
